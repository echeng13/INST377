...
/* Dropdown list will use an array to populate. Dropdown will need to include a function that will return all unique districts.
   Leaflet will likely need all of the addresses with the specified district and we can get that with a filter.
   Need to look into the backend data retrieval to fit the professor's desired methods.
